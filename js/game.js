...
const CARD_IMAGE_IDS = new Set(['apex_form', 'bandage_up', 'strike', 'heavy_slam', 'defend', 'flash_strike', 'purify', 'iron_arm', 'swift_focus', 'anger', 'battle_trance', 'cleave', 'iron_wave', 'thunderclap', 'twin_strike']);
